...
public struct ProcessResult: CustomStringConvertible, Sendable {
  ...
  public init(
    ...
    #endif
    self.init(
      arguments: arguments, environmentBlock: environmentBlock, exitStatus: exitStatus,
      output: output, stderrOutput: stderrOutput)
  }

  @available(
    *, deprecated,
    message: "use `init(arguments:environmentBlock:exitStatusCode:output:stderrOutput:)`"
  )
  public init(
    arguments: [String],
  ...
  @available(
    *, deprecated, message: "use `init(arguments:environmentBlock:exitStatus:output:stderrOutput:)`"
  )
  public init(
    arguments: [String],
    environment: [String: String],
...
public final class Process {
  ...
  public enum OutputRedirection {
    ...
    public static func stream(stdout: @escaping OutputClosure, stderr: @escaping OutputClosure)
      -> Self
    {
  ...
  public var environment: [String: String] {
    [String: String](uniqueKeysWithValues: environmentBlock.map { ($0.key.value, $0.value) })
  }
  ...
  ///   - loggingHandler: Handler for logging messages
  public init(
    arguments: [String], environmentBlock: ProcessEnvironmentBlock = ProcessEnv.block,
  ...
  @available(
    *, deprecated,
    renamed:
      "init(arguments:environmentBlock:outputRedirection:startNewProcessGroup:loggingHandler:)"
  )
  public convenience init(
    arguments: [String],
    environment: [String: String] = ProcessEnv.vars,
  ...
  @_disfavoredOverload
  @available(
    *, deprecated, renamed: "init(args:environmentBlock:outputRedirection:loggingHandler:)"
  )
  public convenience init(
    args: String...,
    environment: [String: String] = ProcessEnv.vars,
  ...
  public func launch() throws -> WritableByteStream {
    precondition(
      arguments.count > 0 && !arguments[0].isEmpty,
    ...
    guard
      let executablePath = Process.findExecutable(executable, workingDirectory: workingDirectory)
    else {
      ...
      process.environment = [String: String](
        uniqueKeysWithValues: environmentBlock.map { ($0.key.value, $0.value) })
        ...
        if !outputRedirection.redirectsOutput {
          ...
          let stdoutThread = Thread { [weak self] in
            if let readResult = self?.readOutput(
              onFD: outputPipe[0], outputClosure: outputClosures?.stdoutClosure)
            {
          ...
          if !outputRedirection.redirectStderr {
            ...
            stderrThread = Thread { [weak self] in
              if let readResult = self?.readOutput(
                onFD: stderrPipe[0], outputClosure: outputClosures?.stderrClosure)
              {
                pendingLock.withLock {
...
extension Process {
  ...
  static public func popen(
    ...
    try await popen(
      arguments: arguments, environmentBlock: .init(environment), loggingHandler: loggingHandler)
  }
  ...
  static public func popen(
    ...
    try await popen(
      arguments: args, environmentBlock: environmentBlock, loggingHandler: loggingHandler)
  }
  ...
  static public func popen(
    ...
    try await popen(
      arguments: args, environmentBlock: .init(environment), loggingHandler: loggingHandler)
  }
  ...
  static public func checkNonZeroExit(
    ...
    let result = try await popen(
      arguments: arguments, environmentBlock: environmentBlock, loggingHandler: loggingHandler)
...
extension Process {
  ...
  @_disfavoredOverload
  @available(
    *, deprecated, renamed: "popen(arguments:environmentBlock:loggingHandler:queue:completion:)"
  )
  static public func popen(
    arguments: [String],
    environment: [String: String] = ProcessEnv.vars,
...
// MARK: - Private helpers
  ...
  /// Open the given pipe.
  private func open(pipe _pipe: inout [Int32]) throws {
    let rv = pipe(&_pipe)
    guard rv == 0 else {
