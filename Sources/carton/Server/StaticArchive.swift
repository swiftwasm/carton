...
let staticArchiveHash = ByteString([
  0xBB, 0xEF, 0xFF, 0x58, 0xD2, 0xD7, 0xCA, 0xA6, 0x59, 0xA4, 0x09, 0x83, 0x37, 0x93, 0xB9, 0x8C,
  0x96, 0xB7, 0xE7, 0x67, 0xA3, 0x31, 0xE9, 0x16, 0x53, 0x84, 0x51, 0x94, 0x15, 0x8A, 0x3D, 0xAC,
])
